...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('transaksi/hitung/ajax_list')?>",
            "type": "POST"
        },
...
function edit_uptd(id_uptd)
{
    ...
    $.ajax({
        url : "<?php echo site_url('transaksi/hitung/ajax_edit')?>/" + id_uptd,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('transaksi/hitung/ajax_add')?>";
    } else {
        url = "<?php echo site_url('transaksi/hitung/ajax_update')?>";
    }
...
function delete_uptd(id_uptd)
{
    if(confirm('Anda Yakin Menghapus Data Ini?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('transaksi/hitung/ajax_delete')?>/"+id_uptd,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
